import { useState, useRef, useEffect, forwardRef, useImperativeHandle } from 'react'; // ADDED THIS LINE
...
// CHANGED THIS LINE
const Chatbot = forwardRef(function Chatbot({ selectedAvatar, userProfile, selectedLogId = null }, ref) {
  ...
  useImperativeHandle(ref, () => ({
    resetChat() {
      setMessages([]);
      setNewMessage('');
      window.speechSynthesis.cancel(); // <-- Add this line to stop TTS when resetting
    }
  }));  
    ...
    <div className="relative flex flex-col h-full min-h-0">
      ...
      <div className="flex-1 overflow-y-auto px-4 pt-6 min-h-0">
        {messages.length === 0 ? (
          ...
          <ChatMessages messages={messages} isLoading={isLoading} selectedAvatar={selectedAvatar} />
        )}
